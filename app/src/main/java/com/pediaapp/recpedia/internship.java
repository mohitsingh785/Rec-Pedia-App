...
import com.pediaapp.recpedia.databinding.ActivityInternshipBinding;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        binding.cliclkgere.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                intent.setData(Uri.parse("https://drive.google.com/file/d/10PcyUEz16lIKVC2lrZKLsEKvFQPVdv4G/view?usp=sharing"));
